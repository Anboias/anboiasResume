        ...
        <div className="row h-100">
          <div className="col-12 my-auto">
            ...
            <div className="text-center color-white mb-3 pb-3">
              ...
              <p className="m-0 p-0">
                I am <strong>Bogdan Iasinovschi,</strong>
              </p>
              <p className="m-0 p-0">
                [Icon] <strong>29</strong> years old,{" "}
              </p>
              <p className="m-0 p-0">
                [Icon] based in <strong>Cluj-Napoca, Romania</strong>
              </p>
              <p className="m-0 p-0">
                [Icon] and I am a passionate <strong>Web Developer</strong>,
